...
def get_youtube_links(filename):
    if "Python" in filename:
        return {
            ...
            "hin": "https://www.youtube.com/watch?v=aqvDTCpNRek",
            "hin_title": "CodeWithHarry - Python Tutorial in One Video"
        }
        ...
        return {
            ...
            "hin_title": "CodeWithHarry - DSA Course in Hindi"
        }
    elif "Data" in filename or "NumPy" in filename or "Pandas" in filename:
        return {
            "eng": "https://www.youtube.com/watch?v=r-uOLxNrNk8",
            "eng_title": "freeCodeCamp - Data Analysis with Python",
            "hin": "https://www.youtube.com/watch?v=zN2ZvXm3txM",
            "hin_title": "CodeWithHarry - Pandas Data Analysis"
        }
    else:
        # Default to ML / AI
        return {
            ...
            "hin": "https://www.youtube.com/watch?v=QpTaq2V8b2Y",
            "hin_title": "Krish Naik - Machine Learning Tutorial"
        }
...
print("All PDFs updated with VERIFIED YouTube video links successfully.")
